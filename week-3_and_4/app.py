...
# PAGE 2 : FORECAST EXPLORER
    ...
    comparison = pd.read_csv("week-3_and_4/comparison_table.csv")
    forecast = pd.read_csv("week-3_and_4/segment_forecast.csv", index_col=0)
...
""")
    ...
    anomaly = pd.read_csv("week-3_and_4/anomaly_points.csv")
...
#  PAGE 4 : DEMAND SEGMENTS
    ...
    segment=pd.read_csv("week-3_and_4/segment_data.csv")
